...
class Db{
	...
	public function __construct(){
		...
		try {
			...
			if(strcmp(OUR_DOMAINNAME, LIVE_DOMAIN) == 0) {
			    ...
			    $username = 'canadianimmi_site';

				$password = 'site123!@#';

				$database = 'canadianimmi_site';
	...
	public function supportEmail($emailId = 'info'){
		...
		if(!array_key_exists($emailId, $emailAddress)){
			...
			return 'shobhancse@gmail.com';
                        //return 'imran.skitsbd@gmail.com';
	...
	public function seoInfo($metaName = 'metaTitle'){
		...
		$SEOmetaData['metaSiteName'] = "Canadian Immigration and Legal Services Inc";

		$SEOmetaData['metaTitle'] = "Canadian Immigration Legal Services Inc | Canadian Immigration";

		$SEOmetaData['metaKeyword'] = "Notary public Canada, Family sponsorship Canada, LMIA Canada, Sponsorship appeals Canada, Salauddin Ahmed Canada.";

		$SEOmetaData['metaDescription'] = "Notary Public for Legal official. Family Sponsorship Immigrant support. LMIA Work Assessment. Sponsorship Appeals Challenging immigration decisions in Canada.";

		$SEOmetaData['metaDomain'] = "https://canadianimmigrationlegal.com/";

		$SEOmetaData['metaImage'] = $SEOmetaData['metaDomain']."assets/accounts/seo_42_342.jpg";
