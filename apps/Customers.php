						...
						<div class=\"col-sm-9\">
							...
							$htmlStr .= "</span>
								...
								if($customers_publish>0){
									...
									$htmlStr .= "<input type=\"button\" class=\"btn btn-default edit mbottom10 \" id=\"picbutton\" onClick=\"upload_dialog('Upload Customer Picture', 'customers', 'customer_$customers_id"."_');\" value=\"$picbutton\">
									<input type=\"button\" class=\"btn edit mbottom10 marginright15\" title=\"Edit\" onclick=\"AJget_CustomersPopup($customers_id);\" value=\"Edit\">";

									// $htmlStr .= "<input type=\"button\" class=\"btn btn-default mbottom10 marginright15\" title=\"Merge Customers\" onclick=\"AJmergeCustomersPopup($customers_id);\" value=\"Merge Customers\">
									// <input type=\"button\" class=\"btn edit mbottom10 marginright15\" title=\"Edit\" onclick=\"AJget_CustomersPopup($customers_id);\" value=\"Edit\">";
	...
	public function aJget_CustomersPopup(){
		...
		if($customers_id>0){
			...
			if($customersObj){
				...
				$customersData['description'] = stripslashes(trim($customersRow->description));
				$customersData['uri_value'] = stripslashes(trim($customersRow->uri_value));
