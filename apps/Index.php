...
class Index{
            ...
            if($bannObj){
                ...
                <div class="carousel-cell" style="background-image:url(\'/assets/images/banner1s.jpg\');">
                    <div class="slide-content">
                        <div class="mask">
                            <p class="caption">PROFESSIONAL <b>ACCOUNTS </b> & TAX<b> SOLUTIONS</b> SERVICES</p>
                        </div>
                        <div class="mask">
                ...
                <div class="carousel-cell" style="background-image:url(\'/assets/images/banner4s.jpg\');">
                    <div class="slide-content">
                        <div class="mask">
                            <p class="caption">WE PROVIDE THE BEST<b> BUSINESS REGISTRATION</b> SERVICES<b> AT A</b> AFFORDABLE COST</p>
                        </div>
                        <div class="mask">
                            <a href="'.baseURL.'/contact-us.html" class="btn">Book A Consultation</a>
                        </div>
    ...
    <section class="New Service Area Starts"> 
        ...
        <section>
            <div class="simple-card">
                <div class="our-strength" style="margin-top: 80px;">
                    <div class="strength-card-system">
                        <div class="strength-card-contents"> 
                                <img  src="assets/images/tax1.png" style="width: 50px;" alt=""> 
                                    <h3>Ontario Corporation</h3>
                                    <p>Basic Package $399 <br>  
                                    Agency Filing Fees only $99 <br>
                                    Government Fees $300</p> 
                                    <button type="submit" class="donate-btn button-navy-color txtOswald  mb-1 px-2 py-1 fs-6 rounded-pill">Order Now</button>
                        </div>
                    </div>
                    <div class="strength-card-system">
                        <div class="strength-card-contents">
                            <img  src="assets/images/tax2.png" style="width: 50px;" alt="">   
                    ...
                    <div class="strength-card-system">
                        <div class="strength-card-contents">  
                            <img  src="assets/images/tax3.png" style="width: 50px;" alt=""> 
                ...
                <div class="our-strength" style="margin-top: 20px;">
                    <div class="strength-card-system">
                        <div class="strength-card-contents"> 
                            <img  src="assets/images/tax4.png" style="width: 50px;" alt=""> 
                            <h3>Nuans Report</h3>
                    ...
                    <div class="strength-card-system">
                        <div class="strength-card-contents">  
                            <img  src="assets/images/tax5.png" style="width: 50px;" alt=""> 
                        ...
                        <div class="our-strength" style="margin-top: 80px;">
                            <div class="strength-card">
                                <div class="strength-card-content">
                                    <img  src="assets/images/icon1.png" style="width: 50px;" alt="">
                                    <h3>We Specialize</h3>
                            ...
                            <div class="strength-card">
                                <div class="strength-card-content">
                                    <img  src="assets/images/icon2.png" style="width: 50px;" alt="">
                                    <h3>We Understand</h3>
                            ...
                            <div class="strength-card">
                                <div class="strength-card-content">
                                    <img  src="assets/images/icon3.png" style="width: 50px;" alt="">
                                    <h3>We Guarantee</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="footer-box">
                            ...
                            <p class="welcome">Welcome to Accounting <br> & Tax Solutions Inc.</p>
                            ...
                            <ul class="first-ul">
                                ...
                                <li><span><i class="fa fa-phone-square"></i>
                                    ...
                                    </span><a href="tel:+1 647-867-6351">+1 647-867-6351</a> 



                                </li>

                                <li><span><i class="fa fa-envelope"></i></span><a href="mailto:info.sats98@gmail.com">info.sats98@gmail.com</a></li>

                                <li><span><i class="fa fa-map-marker"></i>

                                    </span><a href="https://www.google.com/maps?ll=43.690391,-79.293086&z=16&t=m&hl=en&gl=CA&mapclient=embed&q=2942+Danforth+Ave+Toronto,+ON+M4C+1M5" target="_blank"> 3098 Danforth Avenue, Toronto, ON, Canada </a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-11">
                        ...
                        <div class="footer-copyright" style="color:#B1B2B6;">
                            ...
                            <p> Copyright ©2023 Accounting & Tax Solutions Inc. All Rights Reserved.  &nbsp;&nbsp; Developed By: <a target="_blank" href="https://sksoftsolutions.ca/"><img class="" src="/assets/accounts/sksoft1.png" width="250px;" alt="SK Soft Solutions" srcset="">&nbsp;</a></p>
