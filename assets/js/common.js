...
function display_image(e){
  document.getElementById('servicesImage').setAttribute('src',e.getAttribute('src'));  
  // document.getElementById('serviceColor').innerText = e.getAttribute('data-img');
}
